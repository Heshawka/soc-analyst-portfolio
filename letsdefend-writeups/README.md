...
|---|---|---|---|
| [SOC108 - Malicious Remote Access Software](./polished/soc108-anydesk-remote-access.md) | Remote Access Software | False Positive | Medium |
| [SOC153 - Suspicious PowerShell Script](./polished/soc153-powershell-c2-exfiltration.md) | PowerShell / C2 / Data Exfiltration | True Positive | High |
